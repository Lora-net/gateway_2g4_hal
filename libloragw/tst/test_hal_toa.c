...
void usage(void) {
    ...
    printf(" -b <uint>  LoRa bandwidth in khz [200, 400, 800, 1600]\n");
    printf(" -l <uint>  LoRa preamble length, [6..65535]\n");
    printf(" -c <uint>  LoRa coding rate [1=4/5 2=4/6 3=4/7 4=4/8 5=4/5-LI 6=4/6-LI 7=4/7-LI]\n");
...
int main(int argc, char **argv) {
        ...
        switch (i) {
            ...
            case 's':
                ...
                if ((i != 1) || (arg_u < 5) || (arg_u > 12)) {
                    ...
                    pkt.datarate = (e_spreading_factor)arg_u;
                }
                break;
            case 'b':
                bw = true; /* param set */
                ...
                if (i != 1) {
                    ...
                    switch (arg_u) {
                        case 200:
                        case 203:
                            pkt.bandwidth = BW_200KHZ;
                            break;
                        case 400:
                        case 406:
                            pkt.bandwidth = BW_400KHZ;
                            break;
                        case 800:
                        case 812:
                            pkt.bandwidth = BW_800KHZ;
                            break;
                        case 1600:
                        case 1625:
                            pkt.bandwidth = BW_1600KHZ;
                            break;
                        default:
                            printf("ERROR: argument parsing of -b argument. Use -h to print help\n");
                            return EXIT_FAILURE;
    ...
    printf("### LoRa 2.4GHz - Time On Air Calculator ###\n");
    ...
    toa_u = lgw_time_on_air(&pkt, &toa_ms);
    printf("=> %.4f ms (%u ms)\n", toa_ms, toa_u);
