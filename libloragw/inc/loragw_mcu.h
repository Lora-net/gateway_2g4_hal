...
typedef enum {
    ...
    ORDER_ID__REQ_CONFIG_RX          = 0x01,
    ORDER_ID__REQ_PREPARE_TX         = 0x02,
    ORDER_ID__REQ_GET_STATUS         = 0x03,
    ORDER_ID__REQ_BOOTLOADER_MODE    = 0x04,
    ORDER_ID__REQ_GET_RX_MSG         = 0x05,
    ORDER_ID__REQ_GET_TX_STATUS      = 0x06,
    ORDER_ID__REQ_RESET              = 0x07,
    ORDER_ID__REQ_SET_COEF_TEMP_RSSI = 0x08,
    ORDER_ID__REQ_READ_REGS          = 0x09,
    ORDER_ID__REQ_WRITE_REGS         = 0x0A,

    ORDER_ID__ACK_PING               = 0x40,
    ORDER_ID__ACK_CONFIG_RX          = 0x41,
    ORDER_ID__ACK_PREPARE_TX         = 0x42,
    ORDER_ID__ACK_GET_STATUS         = 0x43,
    ORDER_ID__ACK_BOOTLOADER_MODE    = 0x44,
    ORDER_ID__ACK_GET_RX_MSG         = 0x45,
    ORDER_ID__ACK_GET_TX_STATUS      = 0x46,
    ORDER_ID__ACK_RESET              = 0x47,
    ORDER_ID__ACK_SET_COEF_TEMP_RSSI = 0x48,
    ORDER_ID__ACK_READ_REGS          = 0x49,
    ORDER_ID__ACK_WRITE_REGS         = 0x4A,

    ORDER_ID__EVT_TX_STATUS   = 0x80,
    ORDER_ID__EVT_MSG_RECEIVE = 0x81,
